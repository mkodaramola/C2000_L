...
//    setupECAP(ECAP2_BASE, HALL2_GPIO,GPIO_22_GPIO22, XBAR_INPUT8);
//    setupECAP(ECAP3_BASE, HALL3_GPIO,GPIO_23_GPIO23, XBAR_INPUT9);
    ...
    while (1) {
        ...
        epwmB.output(&epwmB, 39);

        period = capEvent3 + capEvent4;

        dutyC = (100*capEvent3)/period;

        freq = (DEVICE_SYSCLK_FREQ)/(period*1);
